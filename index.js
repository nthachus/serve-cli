...
!function(modules) {
    ...
    }, $replace = __webpack_require__(11).call(Function.call, String.prototype.replace), rePropName = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, reEscapeChar = /\\(\\)?/g, stringToPath = function(string) {
        var result = [];
    ...
    module.exports = {
        ...
        ucs2length: __webpack_require__(90),
    ...
    "use strict";
    var GetIntrinsic = __webpack_require__(2), callBind = __webpack_require__(69), $indexOf = callBind(GetIntrinsic("String.prototype.indexOf"));
    module.exports = function(name, allowMissing) {
    ...
    "use strict";
    var ES5Type = __webpack_require__(71);
    ...
    "use strict";
    const path = __webpack_require__(0), childProcess = __webpack_require__(8), crossSpawn = __webpack_require__(145), stripEof = __webpack_require__(44), npmRunPath = __webpack_require__(45), isStream = __webpack_require__(46), _getStream = __webpack_require__(157), pFinally = __webpack_require__(49), onExit = __webpack_require__(50), errname = __webpack_require__(165), stdio = __webpack_require__(166);
    ...
    function getStream(process, stream, {encoding: encoding, buffer: buffer, maxBuffer: maxBuffer}) {
    ...
    function makeError(result, options) {
        ...
        const code = result.code, signal = result.signal, parsed = options.parsed, joinedCmd = options.joinedCmd, timedOut = options.timedOut || !1;
        if (!err) {
            let output = "";
    ...
    module.exports = (cmd, args, opts) => {
        const parsed = handleArgs(cmd, args, opts), _parsed$opts = parsed.opts, encoding = _parsed$opts.encoding, buffer = _parsed$opts.buffer, maxBuffer = _parsed$opts.maxBuffer, joinedCmd = joinCmd(cmd, args);
    ...
    "use strict";
    var URI = __webpack_require__(89), equal = __webpack_require__(14), util = __webpack_require__(4), SchemaObject = __webpack_require__(29), traverse = __webpack_require__(91);
    ...
    "use strict";
    const stripAnsi = __webpack_require__(190), isFullwidthCodePoint = __webpack_require__(192);
    module.exports = str => {
    ...
    "use strict";
    var keys = __webpack_require__(63), hasSymbols = "function" == typeof Symbol && "symbol" == typeof Symbol("foo"), toStr = Object.prototype.toString, concat = Array.prototype.concat, origDefineProperty = Object.defineProperty, supportsDescriptors = origDefineProperty && function() {
        var obj = {};
        try {
    ...
    "use strict";
    var CreateDataProperty = __webpack_require__(65), IsCallable = __webpack_require__(24), RequireObjectCoercible = __webpack_require__(25), ToObject = __webpack_require__(85), callBound = __webpack_require__(5), $gOPD = Object.getOwnPropertyDescriptor, $getOwnNames = Object.getOwnPropertyNames, $getSymbols = Object.getOwnPropertySymbols, $concat = callBound("Array.prototype.concat"), $reduce = callBound("Array.prototype.reduce"), getAll = $getSymbols ? function(obj) {
    ...
    "use strict";
    var origSymbol = global.Symbol, hasSymbolSham = __webpack_require__(66);
    ...
    "use strict";
    var GetIntrinsic = __webpack_require__(2), $TypeError = GetIntrinsic("%TypeError%"), $SyntaxError = GetIntrinsic("%SyntaxError%"), has = __webpack_require__(6), predicates = {
    ...
    var cc = __webpack_require__(123), join = __webpack_require__(0).join, deepExtend = __webpack_require__(126), win = "win32" === process.platform, home = win ? process.env.USERPROFILE : process.env.HOME;
    module.exports = function(name, defaults, argv, parse) {
        if ("string" != typeof name) throw new Error("rc(name): name *must* be string");
        argv || (argv = __webpack_require__(127)(process.argv.slice(2))), defaults = ("string" == typeof defaults ? cc.json(defaults) : defaults) || {}, 
    ...
    var buffer = __webpack_require__(130), Buffer = buffer.Buffer;
    ...
    const escapeStringRegexp = __webpack_require__(131), ansiStyles = __webpack_require__(132), stdoutColor = __webpack_require__(137).stdout, template = __webpack_require__(139), isSimpleWindowsTerm = "win32" === process.platform && !(process.env.TERM || "").toLowerCase().startsWith("xterm"), levelMapping = [ "ansi", "ansi", "ansi256", "ansi16m" ], skipModels = new Set([ "gray" ]), styles = Object.create(null);
    ...
    var cssKeywords = __webpack_require__(135), reverseKeywords = {};
    ...
    var isWindows = "win32" === process.platform || "cygwin" === process.env.OSTYPE || "msys" === process.env.OSTYPE, path = __webpack_require__(0), COLON = isWindows ? ";" : ":", isexe = __webpack_require__(149);
    ...
    "use strict";
    var shebangRegex = __webpack_require__(154);
    ...
    "use strict";
    const path = __webpack_require__(0), pathKey = __webpack_require__(42);
    module.exports = opts => {
        let prev;
        opts = Object.assign({
            cwd: process.cwd(),
    ...
    var emitter, assert = __webpack_require__(162), signals = __webpack_require__(163), isWin = /^win/i.test(process.platform), EE = __webpack_require__(164);
    function unload() {
    ...
    "use strict";
    var extensions, types, preference, db = __webpack_require__(52), extname = __webpack_require__(0).extname, EXTRACT_TYPE_REGEXP = /^\s*([^;\s]*)(?:;|\s|$)/, TEXT_TYPE_REGEXP = /^text\//i;
    ...
    "use strict";
    var path = __webpack_require__(0), which = __webpack_require__(41), commandCache = new (__webpack_require__(55))({
        max: 50,
        maxAge: 3e4
    });
    ...
    var makeSymbol, Map = __webpack_require__(202), util = __webpack_require__(3), Yallist = __webpack_require__(204), MAX = (makeSymbol = "function" == typeof Symbol && "1" !== process.env._nodeLRUCacheForceNoSymbol ? function(key) {
        return Symbol(key);
    } : function(key) {
        return "_" + key;
    ...
    (exports = module.exports = createDebug.debug = createDebug.default = createDebug).coerce = function(val) {
        ...
        return !1;
    }, exports.humanize = __webpack_require__(224), exports.names = [], exports.skips = [], 
    exports.formatters = {};
}, function(module, exports, __webpack_require__) {
    function _createForOfIteratorHelper(o) {
        if ("undefined" == typeof Symbol || null == o[Symbol.iterator]) {
    ...
    const http = __webpack_require__(27), https = __webpack_require__(28), path = __webpack_require__(0), fs = __webpack_require__(1), promisify = __webpack_require__(3).promisify, parse = __webpack_require__(12).parse, os = __webpack_require__(9), Ajv = __webpack_require__(87), checkForUpdate = __webpack_require__(121), chalk = __webpack_require__(39), arg = __webpack_require__(140), copy = __webpack_require__(141).write, handler = __webpack_require__(171), schema = __webpack_require__(188), boxen = __webpack_require__(189), compression = __webpack_require__(214), pkg = __webpack_require__(231), readFile = promisify(fs.readFile), compressionHandler = promisify(compression()), interfaces = os.networkInterfaces(), warning = message => chalk`{yellow WARNING:} ${message}`, info = message => chalk`{magenta INFO:} ${message}`, error = message => chalk`{red ERROR:} ${message}`, updateCheck = function() {
...
`);
    ...
    "use strict";
    var util = __webpack_require__(3), getPolyfill = __webpack_require__(60);
    module.exports = function() {
    ...
    "use strict";
    var util = __webpack_require__(3), implementation = __webpack_require__(61);
    module.exports = function() {
    ...
    var getOwnPropertyDescriptors = __webpack_require__(62);
    ...
    var slice = Array.prototype.slice, isArgs = __webpack_require__(18), origKeys = Object.keys, keysShim = origKeys ? function(o) {
        return origKeys(o);
    } : __webpack_require__(64), originalKeys = Object.keys;
    ...
    "use strict";
    var $TypeError = __webpack_require__(2)("%TypeError%"), DefineOwnProperty = __webpack_require__(68), FromPropertyDescriptor = __webpack_require__(70), OrdinaryGetOwnProperty = __webpack_require__(72), IsDataDescriptor = __webpack_require__(79), IsExtensible = __webpack_require__(80), IsPropertyKey = __webpack_require__(22), SameValue = __webpack_require__(82), Type = __webpack_require__(7);
    ...
    "use strict";
    var $defineProperty = __webpack_require__(2)("%Object.defineProperty%", !0);
    ...
    "use strict";
    var bind = __webpack_require__(11), $Function = __webpack_require__(2)("%Function%"), $apply = $Function.apply, $call = $Function.call;
    module.exports = function() {
    ...
    "use strict";
    var GetIntrinsic = __webpack_require__(2), $gOPD = __webpack_require__(73), $TypeError = GetIntrinsic("%TypeError%"), $isEnumerable = __webpack_require__(5)("Object.prototype.propertyIsEnumerable"), has = __webpack_require__(6), IsArray = __webpack_require__(74), IsPropertyKey = __webpack_require__(22), IsRegExp = __webpack_require__(75), ToPropertyDescriptor = __webpack_require__(77), Type = __webpack_require__(7);
    ...
    "use strict";
    var $gOPD = __webpack_require__(2)("%Object.getOwnPropertyDescriptor%");
    if ($gOPD) try {
        $gOPD([], "length");
    } catch (e) {
        $gOPD = null;
    ...
    "use strict";
    var $Array = __webpack_require__(2)("%Array%"), toStr = !$Array.isArray && __webpack_require__(5)("Object.prototype.toString");
    module.exports = $Array.isArray || function(argument) {
        return "[object Array]" === toStr(argument);
    };
}, function(module, exports, __webpack_require__) {
    "use strict";
    var $match = __webpack_require__(2)("%Symbol.match%", !0), hasRegExpMatcher = __webpack_require__(76), ToBoolean = __webpack_require__(23);
    module.exports = function(argument) {
    ...
    "use strict";
    var has = __webpack_require__(6), $TypeError = __webpack_require__(2)("%TypeError%"), Type = __webpack_require__(7), ToBoolean = __webpack_require__(23), IsCallable = __webpack_require__(24);
    module.exports = function(Obj) {
    ...
    "use strict";
    var $Object = __webpack_require__(2)("%Object%"), isPrimitive = __webpack_require__(81), $preventExtensions = $Object.preventExtensions, $isExtensible = $Object.isExtensible;
    ...
    "use strict";
    var $isNaN = __webpack_require__(83);
    ...
    "use strict";
    var $Object = __webpack_require__(2)("%Object%"), RequireObjectCoercible = __webpack_require__(25);
    module.exports = function(value) {
    ...
    "use strict";
    var compileSchema = __webpack_require__(88), resolve = __webpack_require__(13), Cache = __webpack_require__(92), SchemaObject = __webpack_require__(29), stableStringify = __webpack_require__(30), formats = __webpack_require__(93), rules = __webpack_require__(94), $dataMetaSchema = __webpack_require__(115), util = __webpack_require__(4);
    ...
    }, Ajv.prototype.compileAsync = __webpack_require__(116);
    var customKeyword = __webpack_require__(117);
    ...
    function Ajv(opts) {
        ...
        void 0 === opts.serialize && (opts.serialize = stableStringify), this._metaOpts = function(self) {
            ...
            var $dataSchema;
            self._opts.$data && ($dataSchema = __webpack_require__(120), self.addMetaSchema($dataSchema, $dataSchema.$id, !0));
            if (!1 === self._opts.meta) return;
            var metaSchema = __webpack_require__(36);
    ...
    "use strict";
    var resolve = __webpack_require__(13), util = __webpack_require__(4), errorClasses = __webpack_require__(15), stableStringify = __webpack_require__(30), validateGenerator = __webpack_require__(31), ucs2length = util.ucs2length, equal = __webpack_require__(14), ValidationError = errorClasses.Validation;
    ...
    "use strict";
    var ruleModules = __webpack_require__(95), toHash = __webpack_require__(4).toHash;
    module.exports = function() {
        var RULES = [ {
            type: "number",
            rules: [ {
    ...
    module.exports = {
        ...
        allOf: __webpack_require__(97),
        anyOf: __webpack_require__(98),
        $comment: __webpack_require__(99),
        const: __webpack_require__(100),
        contains: __webpack_require__(101),
        dependencies: __webpack_require__(102),
        enum: __webpack_require__(103),
        format: __webpack_require__(104),
        if: __webpack_require__(105),
        items: __webpack_require__(106),
        ...
        multipleOf: __webpack_require__(107),
        not: __webpack_require__(108),
        oneOf: __webpack_require__(109),
        pattern: __webpack_require__(110),
        properties: __webpack_require__(111),
        propertyNames: __webpack_require__(112),
        required: __webpack_require__(113),
        uniqueItems: __webpack_require__(114),
    ...
    "use strict";
    var IDENTIFIER = /^[a-z_$][a-z0-9_$-]*$/i, customRuleCode = __webpack_require__(118), definitionSchema = __webpack_require__(119);
    module.exports = {
    ...
    const URL = __webpack_require__(12).URL, join = __webpack_require__(0).join, fs = __webpack_require__(1), promisify = __webpack_require__(3).promisify, tmpdir = __webpack_require__(9).tmpdir, registryUrl = __webpack_require__(122), writeFile = promisify(fs.writeFile), mkdir = promisify(fs.mkdir), readFile = promisify(fs.readFile), getFile = function() {
        ...
        var _ref4 = _asyncToGenerator((function*({full: full, scope: scope}, distTag) {
            ...
            try {
                ...
                {
                    const authInfo = __webpack_require__(128)(regURL, {
                        recursive: !0
                    });
    ...
    module.exports = function(scope) {
        var rc = __webpack_require__(37)("npm", {
    ...
    "use strict";
    var fs = __webpack_require__(1), ini = __webpack_require__(124), path = __webpack_require__(0), stripJsonComments = __webpack_require__(125), parse = exports.parse = function(content) {
    ...
    var url = __webpack_require__(12), base64 = __webpack_require__(129), decodeBase64 = base64.decodeBase64, encodeBase64 = base64.encodeBase64;
    ...
    module.exports = function() {
        ...
        (options = options || {}).npmrc = options.npmrc || __webpack_require__(37)("npm", {
            registry: "https://registry.npmjs.org/"
        }), getRegistryAuthInfo(checkUrl = checkUrl || options.npmrc.registry, options) || getLegacyAuthInfo(options.npmrc);
    };
}, function(module, exports, __webpack_require__) {
    const safeBuffer = __webpack_require__(38).Buffer;
    module.exports = {
    ...
    "use strict";
    (function(module) {
        const colorConvert = __webpack_require__(134), wrapAnsi16 = (fn, offset) => function() {
    ...
    var conversions = __webpack_require__(40), route = __webpack_require__(136), convert = {};
    ...
    "use strict";
    const os = __webpack_require__(9), hasFlag = __webpack_require__(138), env = process.env;
    let forceColor;
    ...
    const isWSL = __webpack_require__(142), termux = __webpack_require__(144), linux = __webpack_require__(167), macos = __webpack_require__(168), windows = __webpack_require__(169), platformLib = (() => {
    ...
    }(), exports.read = _asyncToGenerator((function*() {
    ...
    "use strict";
    const os = __webpack_require__(9), fs = __webpack_require__(1), isDocker = __webpack_require__(143), isWsl = () => {
    ...
    const execa = __webpack_require__(10), handler = error => {
    ...
    var _paste, _copy;
    module.exports = {
        copy: (_copy = _asyncToGenerator((function*(options) {
            try {
        ...
        paste: (_paste = _asyncToGenerator((function*(options) {
            try {
    ...
    "use strict";
    const cp = __webpack_require__(8), parse = __webpack_require__(146), enoent = __webpack_require__(156);
    ...
    "use strict";
    const path = __webpack_require__(0), niceTry = __webpack_require__(147), resolveCommand = __webpack_require__(148), escape = __webpack_require__(152), readShebang = __webpack_require__(153), semver = __webpack_require__(155), isWin = "win32" === process.platform, isExecutableRegExp = /\.(?:com|exe)$/i, isCmdShimRegExp = /node_modules[\\/].bin[\\/][^\\/]+\.cmd$/i, supportsShellOption = niceTry(() => semver.satisfies(process.version, "^4.8.0 || ^5.7.0 || >= 6.0.0", !0)) || !1;
    ...
    "use strict";
    const path = __webpack_require__(0), which = __webpack_require__(41), pathKey = __webpack_require__(42)();
    ...
    core = "win32" === process.platform || global.TESTING_WINDOWS ? __webpack_require__(150) : __webpack_require__(151), 
    ...
    "use strict";
    const fs = __webpack_require__(1), shebangCommand = __webpack_require__(43);
    ...
    "use strict";
    const pump = __webpack_require__(158), bufferStream = __webpack_require__(161);
    ...
    function getStream(inputStream, options) {
        ...
        const maxBuffer = (options = Object.assign({
            maxBuffer: 1 / 0
        }, options)).maxBuffer;
        let stream;
    ...
    var once = __webpack_require__(47), eos = __webpack_require__(160), fs = __webpack_require__(1), noop = function() {}, ancient = /^v?\.0/.test(process.version), isFn = function(fn) {
    ...
    var once = __webpack_require__(47), noop = function() {};
    ...
    "use strict";
    const PassThrough = __webpack_require__(48).PassThrough;
    module.exports = options => {
        const array = (options = Object.assign({}, options)).array;
    ...
    const path = __webpack_require__(0), execa = __webpack_require__(10), xselFallback = path.join(__dirname, "vendor/linux/xsel"), copyArguments = [ "--clipboard", "--input" ], pasteArguments = [ "--clipboard", "--output" ], makeError = (xselError, fallbackError) => {
        let error;
        return "ENOENT" === xselError.code ? error = new Error("Couldn't find the `xsel` binary and fallback didn't work. On Debian/Ubuntu you can install xsel with: sudo apt install xsel") : (error = new Error("Both xsel and fallback failed"), 
        error.xselError = xselError), error.fallbackError = fallbackError, error;
    }, xselWithFallback = function() {
        var _ref = _asyncToGenerator((function*(argumentList, options) {
            try {
    ...
    const execa = __webpack_require__(10), env = _objectSpread(_objectSpread({}, process.env), {}, {
        LC_CTYPE: "UTF-8"
    });
    var _paste, _copy;
    module.exports = {
        copy: (_copy = _asyncToGenerator((function*(options) {
            return execa("pbcopy", _objectSpread(_objectSpread({}, options), {}, {
                env: env
            }));
        })), function(_x) {
            return _copy.apply(this, arguments);
        ...
        paste: (_paste = _asyncToGenerator((function*(options) {
            return execa.stdout("pbpaste", _objectSpread(_objectSpread({}, options), {}, {
                env: env
            }));
        })), function(_x2) {
            return _paste.apply(this, arguments);
        }),
        copySync: options => execa.sync("pbcopy", _objectSpread(_objectSpread({}, options), {}, {
            env: env
        })),
        pasteSync: options => execa.sync("pbpaste", _objectSpread(_objectSpread({}, options), {}, {
            env: env
        }))
    };
}, function(module, exports, __webpack_require__) {
    ...
    const path = __webpack_require__(0), execa = __webpack_require__(10), windowBinaryPath = "x64" === __webpack_require__(170)() ? path.join(__dirname, "vendor/windows/clipboard_x86_64.exe") : path.join(__dirname, "vendor/windows/clipboard_i686.exe");
    var _paste, _copy;
    module.exports = {
        copy: (_copy = _asyncToGenerator((function*(options) {
    ...
    var cp = __webpack_require__(8), fs = __webpack_require__(1), path = __webpack_require__(0);
    module.exports = function() {
    ...
    const promisify = __webpack_require__(3).promisify, path = __webpack_require__(0), createHash = __webpack_require__(172).createHash, _require3 = __webpack_require__(1), realpath = _require3.realpath, lstat = _require3.lstat, createReadStream = _require3.createReadStream, readdir = _require3.readdir, url = __webpack_require__(173), slasher = __webpack_require__(176), minimatch = __webpack_require__(177), pathToRegExp = __webpack_require__(181), mime = __webpack_require__(51), bytes = __webpack_require__(53), contentDisposition = __webpack_require__(183), isPathInside = __webpack_require__(184), parseRange = __webpack_require__(185), directoryTemplate = __webpack_require__(186), errorTemplate = __webpack_require__(187), etags = new Map, sourceMatches = (source, requestPath, allowSegments) => {
    ...
    var GLOBSTAR = minimatch.GLOBSTAR = Minimatch.GLOBSTAR = {}, expand = __webpack_require__(178), plTypes = {
        "!": {
            open: "(?:(?!(?:",
            close: "))[^/]*?)"
        },
    ...
    var concatMap = __webpack_require__(179), balanced = __webpack_require__(180);
    module.exports = function(str) {
        if (!str) return [];
    ...
    "use strict";
    const stringWidth = __webpack_require__(16), chalk = __webpack_require__(39), widestLine = __webpack_require__(193), cliBoxes = __webpack_require__(194), camelCase = __webpack_require__(196), ansiAlign = __webpack_require__(197), termSize = __webpack_require__(198), getObject = detail => {
        let obj;
    ...
    "use strict";
    const ansiRegex = __webpack_require__(191);
    ...
    "use strict";
    const path = __webpack_require__(0), execa = __webpack_require__(199), create = (columns, rows) => ({
    ...
    "use strict";
    const childProcess = __webpack_require__(8), util = __webpack_require__(3), crossSpawn = __webpack_require__(200), stripEof = __webpack_require__(44), npmRunPath = __webpack_require__(45), isStream = __webpack_require__(46), _getStream = __webpack_require__(210), pFinally = __webpack_require__(49), onExit = __webpack_require__(50), errname = __webpack_require__(212), stdio = __webpack_require__(213);
    function handleArgs(cmd, args, opts) {
        let parsed;
        return (opts = Object.assign({
            extendEnv: !0,
    ...
    "use strict";
    var cp = __webpack_require__(8), parse = __webpack_require__(201), enoent = __webpack_require__(208), cpSpawnSync = cp.spawnSync;
    function spawn(command, args, options) {
        var parsed, spawned;
    ...
    module.exports = spawn, module.exports.spawn = spawn, module.exports.sync = function(command, args, options) {
        var parsed, result;
        if (!cpSpawnSync) try {
            cpSpawnSync = __webpack_require__(209);
        } catch (ex) {
    ...
    "use strict";
    var resolveCommand = __webpack_require__(54), hasEmptyArgumentBug = __webpack_require__(205), escapeArgument = __webpack_require__(56), escapeCommand = __webpack_require__(206), readShebang = __webpack_require__(207), isWin = "win32" === process.platform, skipShellRegExp = /\.(?:com|exe)$/i, supportsShellOption = parseInt(process.version.substr(1).split(".")[0], 10) >= 6 || 4 === parseInt(process.version.substr(1).split(".")[0], 10) && parseInt(process.version.substr(1).split(".")[1], 10) >= 8;
    module.exports = function(command, args, options) {
        var parsed;
    ...
    "function" != typeof Map || process.env.TEST_PSEUDOMAP ? module.exports = __webpack_require__(203) : module.exports = Map;
}, function(module, exports) {
    ...
    "use strict";
    var escapeArgument = __webpack_require__(56);
    module.exports = function(command) {
        return /^[a-z0-9_-]+$/i.test(command) ? command : escapeArgument(command, !0);
    };
}, function(module, exports, __webpack_require__) {
    "use strict";
    var fs = __webpack_require__(1), LRU = __webpack_require__(55), shebangCommand = __webpack_require__(43), shebangCache = new LRU({
        max: 50,
        maxAge: 3e4
    });
    module.exports = function(command) {
    ...
    "use strict";
    var isWin = "win32" === process.platform, resolveCommand = __webpack_require__(54), isNode10 = 0 === process.version.indexOf("v0.10.");
    ...
    "use strict";
    var accepts = __webpack_require__(215), Buffer = __webpack_require__(38).Buffer, bytes = __webpack_require__(53), compressible = __webpack_require__(221), debug = __webpack_require__(222)("compression"), onHeaders = __webpack_require__(228), vary = __webpack_require__(229), zlib = __webpack_require__(230);
    ...
    "use strict";
    var Negotiator = __webpack_require__(216), mime = __webpack_require__(51);
    ...
    function loadModule(moduleName) {
        ...
        switch (moduleName) {
          case "charset":
            module = __webpack_require__(217);
            break;

          case "encoding":
            module = __webpack_require__(218);
            break;
    ...
    "use strict";
    var db = __webpack_require__(52), COMPRESSIBLE_TYPE_REGEXP = /^text\/|\+(?:json|text|xml)$/i, EXTRACT_TYPE_REGEXP = /^\s*([^;\s]*)(?:;|\s|$)/;
    ...
    "undefined" != typeof process && "renderer" === process.type ? module.exports = __webpack_require__(223) : module.exports = __webpack_require__(225);
}, function(module, exports, __webpack_require__) {
    function load() {
        var r;
        try {
    ...
    (exports = module.exports = __webpack_require__(57)).log = function() {
    ...
    var tty = __webpack_require__(226), util = __webpack_require__(3);
    (exports = module.exports = __webpack_require__(57)).init = function(debug) {
        debug.inspectOpts = {};
    ...
    var stream = 1 === fd ? process.stdout : 2 === fd ? process.stderr : function(fd) {
        ...
        switch (process.binding("tty_wrap").guessHandleType(fd)) {
          ...
          case "PIPE":
          case "TCP":
            var net = __webpack_require__(227);
