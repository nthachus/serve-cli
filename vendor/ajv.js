module.exports = function(modules) {
  ...
  module.exports = {
    ...
    ucs2length: __webpack_require__(96),
  ...
  "use strict";
  var URI = __webpack_require__(95), equal = __webpack_require__(11), util = __webpack_require__(3), SchemaObject = __webpack_require__(21), traverse = __webpack_require__(97);
  ...
  "use strict";
  var compileSchema = __webpack_require__(94), resolve = __webpack_require__(10), Cache = __webpack_require__(98), SchemaObject = __webpack_require__(21), stableStringify = __webpack_require__(22), formats = __webpack_require__(99), rules = __webpack_require__(100), $dataMetaSchema = __webpack_require__(121), util = __webpack_require__(3);
  ...
  }, Ajv.prototype.compileAsync = __webpack_require__(122);
  var customKeyword = __webpack_require__(123);
  ...
  function Ajv(opts) {
    ...
    void 0 === opts.serialize && (opts.serialize = stableStringify), this._metaOpts = function(self) {
      ...
      var $dataSchema;
      self._opts.$data && ($dataSchema = __webpack_require__(125), self.addMetaSchema($dataSchema, $dataSchema.$id, !0));
      if (!1 === self._opts.meta) return;
      var metaSchema = __webpack_require__(126);
  ...
  "use strict";
  var resolve = __webpack_require__(10), util = __webpack_require__(3), errorClasses = __webpack_require__(12), stableStringify = __webpack_require__(22), validateGenerator = __webpack_require__(23), ucs2length = util.ucs2length, equal = __webpack_require__(11), ValidationError = errorClasses.Validation;
  ...
  SCHEMES[handler$3.scheme] = handler$3, SCHEMES[handler$4.scheme] = handler$4, exports.parse = parse, 
  exports.serialize = serialize, exports.resolve = function(baseURI, relativeURI, options) {
    ...
    return serialize(function(base, relative) {
    ...
    }(parse(baseURI, schemelessOptions), parse(relativeURI, schemelessOptions), schemelessOptions, !0), schemelessOptions);
  }, Object.defineProperty(exports, "__esModule", {
    value: !0
  });
}, function(module, exports, __webpack_require__) {
  ...
  "use strict";
  var ruleModules = __webpack_require__(101), toHash = __webpack_require__(3).toHash;
  ...
  "use strict";
  module.exports = {
    $ref: __webpack_require__(102),
    allOf: __webpack_require__(103),
    anyOf: __webpack_require__(104),
    $comment: __webpack_require__(105),
    const: __webpack_require__(106),
    contains: __webpack_require__(107),
    dependencies: __webpack_require__(108),
    enum: __webpack_require__(109),
    format: __webpack_require__(110),
    if: __webpack_require__(111),
    items: __webpack_require__(112),
    maximum: __webpack_require__(24),
    minimum: __webpack_require__(24),
    maxItems: __webpack_require__(25),
    minItems: __webpack_require__(25),
    maxLength: __webpack_require__(26),
    minLength: __webpack_require__(26),
    maxProperties: __webpack_require__(27),
    ...
    required: __webpack_require__(119),
    uniqueItems: __webpack_require__(120),
  ...
  "use strict";
  var IDENTIFIER = /^[a-z_$][a-z0-9_$-]*$/i, customRuleCode = __webpack_require__(124);
  module.exports = {
