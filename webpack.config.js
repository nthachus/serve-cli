...
module.exports = {
    ...
    rules: [
      {
        ...
        test: [
          ...
          /node_modules.(arg|boxen|camelcase|clipboardy|is-(docker|fullwidth|wsl)|serve|string|term|tiny|update|widest)\b.*\.m?js$/i,
  ...
  plugins: [
    ...
    new BannerPlugin({ banner: 'module.exports =', raw: true, test: /vendor\b.[^\\/]*\.js$/i }),
  ],
  optimization: {
    nodeEnv: false,
    // minimize: false,
